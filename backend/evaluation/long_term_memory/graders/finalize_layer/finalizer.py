...
from evaluation.long_term_memory.graders.finalize_layer.adjudication_router import route_human_review
from evaluation.long_term_memory.graders.finalize_layer.aggregation import finalize_case_result


class LongTermMemoryFinalizer:
    def finalize(
        self,
        case: EvalCase,
        *,
        ...
        result: FinalEvalResult = {
            ...
            "topic": str(raw_case.get("topic") or "long_term_memory"),
