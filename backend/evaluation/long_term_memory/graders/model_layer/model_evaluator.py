...
from evaluation.long_term_memory.graders.model_layer.llm_runtime import LongTermMemoryLLMRuntime


class LongTermMemoryModelEvaluator:
    def __init__(
        self,
        *,
        use_llm: bool = False,
        ...
        self._runtime = LongTermMemoryLLMRuntime() if use_llm else None
