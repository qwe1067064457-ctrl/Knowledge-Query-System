...
from evaluation.long_term_memory.graders.model_layer.memory_llm_grader import LongTermMemoryLLMGrader


class LongTermMemoryLLMRuntime:
    def __init__(self) -> None:
        self.grader = LongTermMemoryLLMGrader()
