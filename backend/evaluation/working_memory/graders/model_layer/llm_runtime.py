...
from evaluation.working_memory.graders.model_layer.working_memory_llm_grader import WorkingMemoryLLMGrader


class WorkingMemoryLLMRuntime:
    def __init__(self) -> None:
        self.grader = WorkingMemoryLLMGrader()
