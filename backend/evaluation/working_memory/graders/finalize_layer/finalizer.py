...
from evaluation.working_memory.graders.finalize_layer.adjudication_router import route_human_review
from evaluation.working_memory.graders.finalize_layer.aggregation import finalize_case_result
    ...
    def finalize(
        ...
        *,
        ...
        result: FinalEvalResult = {
            ...
            "topic": str(raw_case.get("topic") or "working_memory"),
