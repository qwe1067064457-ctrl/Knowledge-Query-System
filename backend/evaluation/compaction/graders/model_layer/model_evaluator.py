...
from evaluation.compaction.graders.model_layer.llm_runtime import CompactionLLMRuntime
from evaluation.core.types import EvalCase, ModelEvalResult


class CompactionModelEvaluator:
    def __init__(
        self,
        *,
        use_llm: bool = False,
        ...
        self._runtime = CompactionLLMRuntime() if use_llm else None
